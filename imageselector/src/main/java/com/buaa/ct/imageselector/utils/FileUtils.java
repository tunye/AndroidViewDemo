package com.buaa.ct.imageselector.utils;
...
public class FileUtils {
    ...
    public static String ROOT_PATH = "iyuba/music/image";
    public static String CAMERA_PATH = "/" + ROOT_PATH + "/CameraImage/";
    public static String CROP_PATH = "/" + ROOT_PATH + "/CropImage/";
