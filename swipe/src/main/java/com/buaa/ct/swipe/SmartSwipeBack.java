...
import static com.buaa.ct.swipe.SwipeConsumer.DIRECTION_LEFT;
...
public class SmartSwipeBack {
    ...
    public static void activityStayBack(Application application, ActivitySwipeBackFilter filter) {
    ...
    public static void activityStayBack(Application application, ActivitySwipeBackFilter filter, final int edgeSize, final int minVelocity, final int direction) {
    ...
    public static void activitySlidingBack(Application application, ActivitySwipeBackFilter filter) {
    ...
    public static void activitySlidingBack(Application application, ActivitySwipeBackFilter filter, float factor) {
        //default edge size
        final int edgeSize = SmartSwipe.dp2px(20, application);
    ...
    public static void activityBezierBack(Application application, ActivitySwipeBackFilter filter) {
        final int edgeSize = SmartSwipe.dp2px(20, application);
    ...
    public static void activityBezierBack(Application application, ActivitySwipeBackFilter filter, int edgeSize) {
    ...
    public static void activityDoorBack(Application application, ActivitySwipeBackFilter filter) {
        final int edgeSize = SmartSwipe.dp2px(20, application);
    ...
    public static void activityShuttersBack(Application application, ActivitySwipeBackFilter filter) {
        final int edgeSize = SmartSwipe.dp2px(20, application);
        final int scrimColor = 0x80000000;
        final boolean refreshable = true;
