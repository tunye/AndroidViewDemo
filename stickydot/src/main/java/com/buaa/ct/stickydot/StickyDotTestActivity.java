...
import com.buaa.ct.stickydot.utils.DisplayUtils;
import com.buaa.ct.stickydot.view.StickyViewHelper;
 ...
 *
 */
public class StickyDotTestActivity extends AppCompatActivity {
    private ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sticky_dot_test);
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = LayoutInflater.from(mContext).inflate(R.layout.sticky_dot_test_item, parent, false);
             ...
             * 布局方式请参考xml文件
             */
            StickyViewHelper stickyViewHelper = new StickyViewHelper(mContext, viewHolder.mDragView, R.layout.sticky_dot_test_item_include);
