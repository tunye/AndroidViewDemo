package com.buaa.ct.stickydot.view;
...
import com.buaa.ct.stickydot.utils.GeometryUtil;
...
//      需要手动测量
        ...
        mFixRadius = DisplayUtils.dip2Dimension(16, mContext);
        mFarthestDistance = DisplayUtils.dip2Dimension(200, mContext);
        mMinFixRadius = DisplayUtils.dip2Dimension(2f, mContext);
