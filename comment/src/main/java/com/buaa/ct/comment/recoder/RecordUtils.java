...
public class RecordUtils {
    public final static String BASE_DIR = Environment
            .getExternalStorageDirectory().getAbsolutePath() + "/iyuba/music/";
    public static final String RECORD_DIR = BASE_DIR + "record";
    ...
    public static String getNewRecordFile() {
        return RECORD_DIR + "/" + System.currentTimeMillis() + ".amr";
    }
}
