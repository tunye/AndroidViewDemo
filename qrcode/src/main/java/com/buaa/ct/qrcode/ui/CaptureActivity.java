...
public class CaptureActivity extends AppCompatActivity {
    ...
    public final static String KEY_CAPTURE_THEME = "com.buaa.ct.qrcode.ui.KEY_CAPTURE_THEME";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        setTheme(getIntent().getIntExtra(KEY_CAPTURE_THEME, R.style.QRCodeTheme));
    ...
    protected void handleAnalyzeSuccess(Bitmap bitmap, String result) {
        ...
        bundle.putInt(QRCode.RESULT_TYPE, QRCode.RESULT_SUCCESS);
        bundle.putString(QRCode.RESULT_DATA, result);
    ...
    protected void handleAnalyzeFailed() {
        Intent resultIntent = new Intent();
        Bundle bundle = new Bundle();
        bundle.putInt(QRCode.RESULT_TYPE, QRCode.RESULT_FAILED);
        bundle.putString(QRCode.RESULT_DATA, "");
        resultIntent.putExtras(bundle);
        setResult(RESULT_OK, resultIntent);
        finish();
    }
