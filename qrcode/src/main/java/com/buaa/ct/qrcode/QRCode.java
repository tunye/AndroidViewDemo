...
import com.buaa.ct.qrcode.camera.AutoFocusCallback;
import com.buaa.ct.qrcode.camera.CameraManager;
import com.buaa.ct.qrcode.logs.QCLog;
...
import com.buaa.ct.qrcode.util.QRCodeProduceUtils.Builder;

import java.util.List;

import static com.buaa.ct.qrcode.util.QRCodeProduceUtils.QRCODE_BITMAP_MAX_SIZE;
...
public class QRCode {
     ...
     * 默认二维码扫描的activity启动
     */
    public static final String ACTION_DEFAULT_CAPTURE = "com.buaa.ct.qrcode.ui.captureactivity";
    ...
    public static void setAutoFocusInterval(long sAutoFocusInterval) {
        QRCode.sAutoFocusInterval = sAutoFocusInterval;
    }
    ...
    public static void startScan(Fragment fragment, int requestCode) {
        CaptureActivity.start(fragment, requestCode, R.style.QRCodeTheme);
    }
    ...
    public static void startScan(Activity activity, int requestCode) {
        CaptureActivity.start(activity, requestCode, R.style.QRCodeTheme);
    }
